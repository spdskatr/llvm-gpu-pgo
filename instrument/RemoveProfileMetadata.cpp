...
// Scrubs all profile metadata from the function and the ProfileSummary from the
// module containing it. Useful for debugging purposes.
PreservedAnalyses RemoveProfileMetadataPass::run(Function &F,
