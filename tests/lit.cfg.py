...
config.environment["LLVM_ROOT"] = os.environ.get("LLVM_ROOT") or "/home/ts862/llvm17/build"
config.environment["GPUPGO_ROOT"] = os.environ.get("GPUPGO_ROOT") or "/home/ts862/llvm-gpu-pgo"
